...
func getDiDefs(provider dingo.Provider) []di.Def {
	return []di.Def{
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("task-controller")
				if err != nil {
					var eo controllers.TaskController
					return eo, err
				}
				pi0, err := ctn.SafeGet("task-service")
				if err != nil {
					var eo controllers.TaskController
					return eo, err
				}
				p0, ok := pi0.(services.ITaskService)
				if !ok {
					var eo controllers.TaskController
					return eo, errors.New("could not cast parameter 0 to services.ITaskService")
				}
				b, ok := d.Build.(func(services.ITaskService) (controllers.TaskController, error))
				if !ok {
					var eo controllers.TaskController
					return eo, errors.New("could not cast build function to func(services.ITaskService) (controllers.TaskController, error)")
				}
				return b(p0)
			},
			Close: func(obj interface{}) error {
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("task-repository")
				if err != nil {
				...
				b, ok := d.Build.(func(infrastructures.IGormDatabase) (repositories.IUTaskListRepository, error))
				if !ok {
					var eo repositories.IUTaskListRepository
					return eo, errors.New("could not cast build function to func(infrastructures.IGormDatabase) (repositories.IUTaskListRepository, error)")
				}
				return b(p0)
			},
			Close: func(obj interface{}) error {
		...
		},
		{
			...
			Scope: "app",
			Build: func(ctn di.Container) (interface{}, error) {
				d, err := provider.Get("task-service")
				if err != nil {
					var eo services.ITaskService
					return eo, err
				}
				pi0, err := ctn.SafeGet("task-repository")
				if err != nil {
					var eo services.ITaskService
					return eo, err
				}
				p0, ok := pi0.(repositories.IUTaskListRepository)
				if !ok {
					var eo services.ITaskService
					return eo, errors.New("could not cast parameter 0 to repositories.IUTaskListRepository")
				}
				b, ok := d.Build.(func(repositories.IUTaskListRepository) (services.ITaskService, error))
				if !ok {
					var eo services.ITaskService
					return eo, errors.New("could not cast build function to func(repositories.IUTaskListRepository) (services.ITaskService, error)")
				}
				return b(p0)
			},
			Close: func(obj interface{}) error {
