...
// SafeGetTaskController works like SafeGet but only for TaskController.
// It does not return an interface but a controllers.TaskController.
func (c *Container) SafeGetTaskController() (controllers.TaskController, error) {
	i, err := c.ctn.SafeGet("task-controller")
	if err != nil {
		var eo controllers.TaskController
		return eo, err
	}
	o, ok := i.(controllers.TaskController)
	if !ok {
		return o, errors.New("could get 'task-controller' because the object could not be cast to controllers.TaskController")
	}
	return o, nil
}

// GetTaskController is similar to SafeGetTaskController but it does not return the error.
// Instead it panics.
func (c *Container) GetTaskController() controllers.TaskController {
	o, err := c.SafeGetTaskController()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetTaskController works like UnscopedSafeGet but only for TaskController.
// It does not return an interface but a controllers.TaskController.
func (c *Container) UnscopedSafeGetTaskController() (controllers.TaskController, error) {
	i, err := c.ctn.UnscopedSafeGet("task-controller")
	if err != nil {
		var eo controllers.TaskController
		return eo, err
	}
...
// UnscopedGetTaskController is similar to UnscopedSafeGetTaskController but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetTaskController() controllers.TaskController {
	o, err := c.UnscopedSafeGetTaskController()
	if err != nil {
		panic(err)
	}
	return o
...
// TaskController is similar to GetTaskController.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetTaskController method.
// If the container can not be retrieved, it panics.
func TaskController(i interface{}) controllers.TaskController {
	return C(i).GetTaskController()
}

// SafeGetTaskRepository works like SafeGet but only for TaskRepository.
// It does not return an interface but a repositories.IUTaskListRepository.
func (c *Container) SafeGetTaskRepository() (repositories.IUTaskListRepository, error) {
	i, err := c.ctn.SafeGet("task-repository")
	if err != nil {
		var eo repositories.IUTaskListRepository
		return eo, err
	}
	o, ok := i.(repositories.IUTaskListRepository)
	if !ok {
		return o, errors.New("could get 'task-repository' because the object could not be cast to repositories.IUTaskListRepository")
	}
	return o, nil
}

// GetTaskRepository is similar to SafeGetTaskRepository but it does not return the error.
// Instead it panics.
func (c *Container) GetTaskRepository() repositories.IUTaskListRepository {
	o, err := c.SafeGetTaskRepository()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetTaskRepository works like UnscopedSafeGet but only for TaskRepository.
// It does not return an interface but a repositories.IUTaskListRepository.
func (c *Container) UnscopedSafeGetTaskRepository() (repositories.IUTaskListRepository, error) {
	i, err := c.ctn.UnscopedSafeGet("task-repository")
	if err != nil {
		var eo repositories.IUTaskListRepository
		return eo, err
	}
...
// UnscopedGetTaskRepository is similar to UnscopedSafeGetTaskRepository but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetTaskRepository() repositories.IUTaskListRepository {
	o, err := c.UnscopedSafeGetTaskRepository()
	if err != nil {
		panic(err)
	}
	return o
...
// TaskRepository is similar to GetTaskRepository.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetTaskRepository method.
// If the container can not be retrieved, it panics.
func TaskRepository(i interface{}) repositories.IUTaskListRepository {
	return C(i).GetTaskRepository()
}

// SafeGetTaskService works like SafeGet but only for TaskService.
// It does not return an interface but a services.ITaskService.
func (c *Container) SafeGetTaskService() (services.ITaskService, error) {
	i, err := c.ctn.SafeGet("task-service")
	if err != nil {
		var eo services.ITaskService
		return eo, err
	}
	o, ok := i.(services.ITaskService)
	if !ok {
		return o, errors.New("could get 'task-service' because the object could not be cast to services.ITaskService")
	}
	return o, nil
}

// GetTaskService is similar to SafeGetTaskService but it does not return the error.
// Instead it panics.
func (c *Container) GetTaskService() services.ITaskService {
	o, err := c.SafeGetTaskService()
	if err != nil {
		panic(err)
	}
	return o
...
// UnscopedSafeGetTaskService works like UnscopedSafeGet but only for TaskService.
// It does not return an interface but a services.ITaskService.
func (c *Container) UnscopedSafeGetTaskService() (services.ITaskService, error) {
	i, err := c.ctn.UnscopedSafeGet("task-service")
	if err != nil {
		var eo services.ITaskService
		return eo, err
	}
...
// UnscopedGetTaskService is similar to UnscopedSafeGetTaskService but it does not return the error.
// Instead it panics.
func (c *Container) UnscopedGetTaskService() services.ITaskService {
	o, err := c.UnscopedSafeGetTaskService()
	if err != nil {
		panic(err)
	}
	return o
...
// TaskService is similar to GetTaskService.
// It tries to find the container with the C method and the given interface.
// If the container can be retrieved, it applies the GetTaskService method.
// If the container can not be retrieved, it panics.
func TaskService(i interface{}) services.ITaskService {
	return C(i).GetTaskService()
}
